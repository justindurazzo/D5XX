...
export default function Mixer({ autoplay = false, autoplayDelay = 400 }: MixerProps = {}) {
  ...
  const initAudio = useCallback(() => {
    ...
    // BIG convolution reverb — bumped to 3.4s and longer tail for the transcendent feel.
    const conv = ctx.createConvolver()
    conv.buffer = makeReverbImpulse(ctx, 3.4, 2.1)
  ...
  // LEAD synth — additive (integer harmonics) for warmth, slow 5Hz vibrato for "singing"
